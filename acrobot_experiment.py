...
from train.acrobot import STEPS, N_FIGHTERS, N_WIZARDS, ALGO, CHECKPOINTS_PATH
...
def test_agent(
    ...
    torque_multiplier_perturbation = lambda: np.random.normal(loc=0, scale=0.1)
